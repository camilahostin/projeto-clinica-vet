import datetime
from src.controllers.animal_screen import animal_list
from src.controllers.veterinarian_screen import veterinarian_list
from src.entities.schedule_treatment import ScheduleTreatment
